...
#include "../include/correction_tp2_ex1_tools.h"
...
int main(int argc, char** argv)
{
    ...
    std::string winTitle = "TP 2 - Ex.1 - Interface graphique et visualisation";
    int winWidth         = 800;
    int winHeight        = 600;
    TP2_Ex1_MeshViewer meshViewer(winTitle.c_str(),
                                  winWidth, winHeight,
                                  inputMesh);
