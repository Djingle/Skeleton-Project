...
#include "../include/correction_tp1_ex7_tools.h"
...
int main(int argc, char** argv)
{
    ...
    std::string winTitle = "TP 1 - Ex.7 - Interface graphique et visualisation";
    int winWidth         = 800;
    int winHeight        = 600;
    TP1_Ex7_MeshViewer meshViewer(winTitle.c_str(),
                                  winWidth, winHeight,
                                  inputMesh);
