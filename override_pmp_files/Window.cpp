...
void Window::render_frame()
{
    ...
    std::cout << "Debut computations" << std::endl;
    instance_->do_processing();
    std::cout << "Fin computations" << std::endl;
    // preapre and process ImGUI elements
    if (instance_->show_imgui())
    {
        std::cout << "Debut imgui" << std::endl;
        // start imgui frame
        ImGui_ImplOpenGL3_NewFrame();
        ImGui_ImplGlfw_NewFrame();
        ImGui::NewFrame();
        std::cout << "Fin imgui" << std::endl;
        std::cout << "Debut prepare" << std::endl;
    ...
    // draw scene
    instance_->display();
    std::cout << "Fin draw scene" << std::endl;
    std::cout << "Debut draw GUI" << std::endl;
    // draw GUI
    if (instance_->show_imgui())
    {
        ImGui_ImplOpenGL3_RenderDrawData(ImGui::GetDrawData());
    }
    std::cout << "Fin draw GUI" << std::endl;
